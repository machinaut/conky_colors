...
/*	const char *coverdir=finddir("bin/conkyCover");*/
	...
	fprintf(fp,"\nlua_load %s/scripts/conkyBackground.lua\n", finddir("scripts/conkyBackground.lua") );
	...
	if (clocktype == 0) 
	{
		fprintf(fp,"${goto %.0f}${font Droid Sans:style=Bold:size=%.0f}${time %%A}${font}\n", board_width/3+50,board_width*0.0138);
		fprintf(fp,"${goto %.0f}${voffset -%.0f}${offset -%.0f}${font Droid Sans:style=Bold:size=%.0f}${color2}${time %%B}${color}${font}\n", board_width/3+50, board_width*0.020, board_width*0.02, board_width*0.0486);
		fprintf(fp,"${goto %.0f}${voffset -%.0f}${offset %.0f}${font Arial:style=Bold:size=%.0f}${color1}${time %%d}${color}${font}\n", board_width/3+50, board_width*0.073, board_width*0.1875, board_width*0.069);
		fprintf(fp,"${goto %.0f}${voffset -%.0f}${offset -%.0f}${font Arial:size=%.0f}${time %%H:%%M}${font}\n", board_width/3+50, board_width*0.0138, board_width*0.0069, board_width*0.0347);
	}
	fprintf(fp,"##############\n");
	fprintf(fp,"# - SYSTEM - #\n");
	fprintf(fp,"##############\n");
	...
	if (cpu == 1) {
			...
			fprintf(fp,"${goto %.0f}${font Droid Sans:style=Bold:size=8}${color2}${freq_g}${color} GHZ${font}\n",value_temp1);
			fprintf(fp,"${goto %.0f}CPU1: ${font Droid Sans:style=Bold:size=8}${color1}${cpu cpu1}%%${color}${font}\n",value_temp1);
			if (unit == True)
				fprintf(fp,"${goto %.0f}Tmp: ${font Droid Sans:style=Bold:size=8}${color1}${execi 30 sensors -f | grep 'Core 0' | cut -c14-16}°F${color}${font}\n",value_temp1);
			else
				fprintf(fp,"${goto %.0f}Temp: ${font Droid Sans:style=Bold:size=8}${color1}${execi 30 sensors | grep 'Core 0' | cut -c15-16}°C${color}${font}\n",value_temp1);
	...
	// More then 1 cpu
		...
		for (i = 1; i <= cpu; i++) {
			...
			fprintf(fp,"${goto %.0f}${font Droid Sans:style=Bold:size=8}${color2}${freq_g %d}${color} GHZ${font}\n",value_temp1, i);
			fprintf(fp,"${goto %.0f}CPU%d: ${font Droid Sans:style=Bold:size=8}${color1}${cpu cpu%d}%%${color}${font}\n",value_temp1, i, i);
			if (unit == True)
				fprintf(fp,"${goto %.0f}Tmp: ${font Droid Sans:style=Bold:size=8}${color1}${execi 30 sensors -f | grep 'Core 0' | cut -c14-16}°F${color}${font}\n",value_temp1);
			else
				fprintf(fp,"${goto %.0f}Temp: ${font Droid Sans:style=Bold:size=8}${color1}${execi 30 sensors | grep 'Core 0' | cut -c15-16}°C${color}${font}\n",value_temp1);
	...
	fprintf(fp,"${goto %.0f}RAM: ${font Droid Sans:style=Bold:size=8}${color1}$memperc%%${color}${font}\n",value_temp1);
	fprintf(fp,"${goto %.0f}F: ${font Droid Sans:style=Bold:size=8}${color2}${memeasyfree}${color}${font}\n",value_temp1); 
	fprintf(fp,"${goto %.0f}U: ${font Droid Sans:style=Bold:size=8}${color2}${mem}${color}${font}\n",value_temp1);
	//Swap
	fprintf(fp,"# |--SWAP\n");
	...
	fprintf(fp,"${goto %.0f}SWAP: ${font Droid Sans:style=Bold:size=8}${color1}$swapperc%%${color}${font}\n",value_temp1);
	fprintf(fp,"${goto %.0f}F: ${font Droid Sans:style=Bold:size=8}${color2}${swapmax}${color}${font}\n",value_temp1); 
	fprintf(fp,"${goto %.0f}U: ${font Droid Sans:style=Bold:size=8}${color2}${swap}${color}${font}\n",value_temp1);
	...
	fprintf(fp,"${goto %.0f}F: ${font Droid Sans:style=Bold:size=8}${color2}${fs_free /}${color}${font}\n",value_temp1); 
	fprintf(fp,"${goto %.0f}U: ${font Droid Sans:style=Bold:size=8}${color2}${fs_used /}${color}${font}\n",value_temp1);
	...
	fprintf(fp,"${goto %.0f}F: ${font Droid Sans:style=Bold:size=8}${color2}${fs_free /home}${color}${font}\n",value_temp1); 
	fprintf(fp,"${goto %.0f}U: ${font Droid Sans:style=Bold:size=8}${color2}${fs_used /home}${color}${font}\n",value_temp1);
	...
	fprintf(fp,"${goto %.0f}Up: ${font Droid Sans:style=Bold:size=8}${color1}${upspeed wlan%d}${color}${font}\n",value_temp1, wlan);
	fprintf(fp,"${goto %.0f}Total: ${font Droid Sans:style=Bold:size=8}${color2}${totalup wlan%d}${color}${font}\n",value_temp1, wlan);
	fprintf(fp,"${goto %.0f}Down: ${font Droid Sans:style=Bold:size=8}${color1}${downspeed wlan%d}${color}${font}\n",value_temp1, wlan);
	fprintf(fp,"${goto %.0f}Total: ${font Droid Sans:style=Bold:size=8}${color2}${totaldown wlan%d}${color}${font}\n",value_temp1, wlan);
	fprintf(fp,"${goto %.0f}Signal: ${font Droid Sans:style=Bold:size=8}${color1}${wireless_link_qual wlan%d}%%${color}${font}\n",value_temp1, wlan);
	fprintf(fp,"# |--eth%d\n", eth);
	fprintf(fp,"${else}${if_up eth%d}\n", eth);
	fprintf(fp,"${goto %.0f}Up: ${font Droid Sans:style=Bold:size=8}${color1}${upspeed eth%d}${color}${font}\n",value_temp1, eth);
	fprintf(fp,"${goto %.0f}Total: ${font Droid Sans:style=Bold:size=8}${color2}${totalup eth%d}${color}${font}\n",value_temp1, eth);
	fprintf(fp,"${goto %.0f}Down: ${font Droid Sans:style=Bold:size=8}${color1}${downspeed eth%d}${color}${font}\n",value_temp1, eth);
	fprintf(fp,"${goto %.0f}Total: ${font Droid Sans:style=Bold:size=8}${color2}${totaldown eth%d}${color}${font}\n",value_temp1, eth);
	fprintf(fp,"# |--ppp%d\n", ppp);
	fprintf(fp,"${else}${if_up ppp%d}\n", ppp);
	fprintf(fp,"${goto %.0f}Up: ${font Droid Sans:style=Bold:size=8}${color1}${upspeed ppp%d}${color}${font}\n",value_temp1, ppp);
	fprintf(fp,"${goto %.0f}Total: ${font Droid Sans:style=Bold:size=8}${color2}${totalup ppp%d}${color}${font}\n",value_temp1, ppp);
	fprintf(fp,"${goto %.0f}Down: ${font Droid Sans:style=Bold:size=8}${color1}${downspeed ppp%d}${color}${font}\n",value_temp1, ppp);
	fprintf(fp,"${goto %.0f}Total: ${font Droid Sans:style=Bold:size=8}${color2}${totaldown ppp%d}${color}${font}\n",value_temp1, ppp);
