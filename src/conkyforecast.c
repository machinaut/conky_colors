...
void conkyforecast () {
	...
	if (shiki==1 || shikidust==1 || dust ==1)
		fprintf(fp,"${font Droid Sans:style=Bold:size=8}${voffset 0}${goto 16}[--datatype=DW --startday=1 --shortweekday] ${goto 64}[--datatype=DW --startday=2 --shortweekday] ${goto 112}[--datatype=DW --startday=3 --shortweekday] ${goto 156}[--datatype=DW --startday=4 --shortweekday]${font}\n");
	else
	...
	if (shiki==1 || shikidust==1 || dust ==1)
		fprintf(fp,"${font Droid Sans:style=Bold:size=8}${voffset 0}${goto 14}[--datatype=HT --startday=1 --hideunits --centeredwidth=3]/[--datatype=LT --startday=1 --hideunits --centeredwidth=3] ${goto 59}[--datatype=HT --startday=2 --hideunits --centeredwidth=3]/[--datatype=LT --startday=2 --hideunits --centeredwidth=3] ${goto 104}[--datatype=HT --startday=3 --hideunits --centeredwidth=3]/[--datatype=LT --startday=3 --hideunits --centeredwidth=3] ${goto 151}[--datatype=HT --startday=4 --hideunits --centeredwidth=3]/[--datatype=LT --startday=4 --hideunits --centeredwidth=3]${font}\n");
	else
