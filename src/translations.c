...
void translation () {
	OR_OPTION_START("pt", language) OR_OPTION_END("portuguese", language) {
		...
		snprintf(signal, 31, "Сила на сигнала");
